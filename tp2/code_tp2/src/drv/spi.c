...
void SPI0_Init(SPI_pins* pins, bool mstre, bool cont_scke, bool rooe,
             bool pcsis)
{
    ...
    spi_x->MCR |= SPI_MCR_MSTR(mstre &&1) | SPI_MCR_CONT_SCKE(cont_scke &&1) |
                    ...
                    bool cpol , uint8_t cpha, uint8_t lsfe, uint16_t br)
{
    ...
    switch(br)
    {
        case 125: spi_x->CTAR[ctar_x] |= SPI_CTAR_PBR(5) | SPI_CTAR_BR(16); break;
        case 500: spi_x->CTAR[ctar_x] |= SPI_CTAR_PBR(5) | SPI_CTAR_BR(4); break;
        case 1000: spi_x->CTAR[ctar_x] |= SPI_CTAR_PBR(5) | SPI_CTAR_BR(2); break;
        case 2500: spi_x->CTAR[ctar_x] |= SPI_CTAR_PBR(2) | SPI_CTAR_BR(2); break;
        default: break;
    }

    //asignar pccssck y pasc y esos
