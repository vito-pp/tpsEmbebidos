...
static int bcd7Seg(int bcd);

int display(int num)
{
	//int data = bcd7Seg(num%10);
	sendSerialData(0b0001000001110000);
	sendSerialData(0b0101011111110000);
	sendSerialData(0b1001010101010000);
	sendSerialData(0b1101000001110000);
	return 0;
}
